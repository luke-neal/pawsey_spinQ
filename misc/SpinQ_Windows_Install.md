...
5. SpinQ Software
Open your console in a folder of your choice
...
Extract the zip file into the same location as the first set of files
You should see two folders: SpinQ and SpinQKit-main
Open a console in the SpinQKit-main folder
Execute the following command:
```python
